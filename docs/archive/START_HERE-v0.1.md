# Start Here (v0.1 — archived)

> **Superseded.** This was the original 2–3 day sprint plan that landed the v0.1
> engine and minimal table viewer. The v0.2 build (5-beat 3D walkthrough) is
> complete; see the top-level `README.md` and `docs/demo-script.md` for the
> current entry points. Kept for history.
